...
class AppMetricSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $sampleData = [
            '00:00' => [0,     0,     0,     0,    0,    0],
            '01:00' => [8075,  4419,  10262, 2.32, 1.27, 0.5472],
            '02:00' => [14334, 6905,  15439, 2.24, 1.08, 0.4817],
            '03:00' => [18527, 9276,  20497, 2.21, 1.11, 0.5007],
            '04:00' => [21180, 10742, 23591, 2.20, 1.11, 0.5072],
            '05:00' => [23020, 11738, 25757, 2.19, 1.12, 0.5099],
            '06:00' => [24290, 12403, 27170, 2.19, 1.12, 0.5106],
            '07:00' => [25424, 13026, 28541, 2.19, 1.12, 0.5124],
            '08:00' => [26723, 13705, 29983, 2.19, 1.12, 0.5129],
            '09:00' => [28568, 14607, 31942, 2.19, 1.12, 0.5113],
            '10:00' => [30643, 15742, 34394, 2.18, 1.12, 0.5137],
            '11:00' => [33501, 17330, 37847, 2.18, 1.13, 0.5173],
            '12:00' => [35817, 18609, 40674, 2.19, 1.14, 0.5196],
            '13:00' => [38505, 19315, 42176, 2.18, 1.10, 0.5016],
            '14:00' => [42427, 20177, 43876, 2.17, 1.03, 0.4756],
            '15:00' => [46568, 22431, 49256, 2.20, 1.06, 0.4817],
            '16:00' => [51061, 24891, 54931, 2.21, 1.08, 0.4875],
            '17:00' => [54754, 26985, 59584, 2.21, 1.09, 0.4928],
            '18:00' => [58435, 28989, 64203, 2.21, 1.10, 0.4961],
            '19:00' => [61509, 30603, 67930, 2.22, 1.10, 0.4975],
            '20:00' => [64600, 32341, 71840, 2.22, 1.11, 0.5006],
            '21:00' => [68697, 34592, 77146, 2.23, 1.12, 0.5035],
            '22:00' => [73456, 37242, 83195, 2.23, 1.13, 0.5070],
            '23:00' => [79497, 40472, 90472, 2.24, 1.14, 0.5091],
        ];
